...
* **Wallet PEM Keys:**\
  <mark style="color:red;">Wallet PEM Keys are required for project registration and are securely stored in the database.</mark>
...
* **Wallet Requirements -**&#x45;ach wallet must have:
...
{% hint style="danger" %}
**Always create new wallets for ESDT Tipping Bot and keep as little tokens as possible. The PEM file is being stored on the server, in the event of server hack your wallet might be compromised and you are at risk loosing all the tokens in the wallets registered with bot. Be smart, keep it as light as possible!**
{% endhint %}
