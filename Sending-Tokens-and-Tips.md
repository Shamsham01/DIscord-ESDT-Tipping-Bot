...
This page explains how admins can send ESDT tokens and tips, and how users can initiate P2P tips using the ESDT Tipping Bot.
...
- **Buy REWARD:** [Buy REWARD on DEX](<REWARD_DEX_LINK_PLACEHOLDER>) or in xPortal.
